        ...
        try {
          ...
          if (piUserId) {
            await supabase.from('notifications').insert({
              ...
              title: 'Retainer Refunded',
              message: `The retainer for this job has been refunded to the client. Your payout of $${(transaction.payout_amount_cents / 100).toFixed(2)} has been reversed.`
            })
          }
        } catch (reverseErr) {
