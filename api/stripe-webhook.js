      ...
      case 'checkout.session.completed': {
        ...
        if (referral?.referring_pi?.stripe_customer_id) {
          try {
            ...
            await supabase.from('notifications').insert({ user_id: referral.referring_pi_id, type: 'referral_bonus', title: 'Referral Bonus Earned!', message: `${referral.referred_pi_email} subscribed. A $${(creditCents/100).toFixed(2)} credit applied.` })
