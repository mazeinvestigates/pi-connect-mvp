  ...
  const handlePISignup = async (e) => {
    ...
    try {
      ...
      if (authData.user) {
        ...
        // Wait for the DB trigger to create the profiles row (up to 3 seconds)
        ...
        for (let i = 0; i < 6; i++) {
          ...
          const { data: profileCheck } = await supabase
            ...
            .maybeSingle()
          if (profileCheck) { profileExists = true; break }
        }
        ...
        // Create PI profile now that profiles row exists
