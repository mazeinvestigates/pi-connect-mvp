...
function isWithinRadius(pi, searchCoords) {
  ...
  // Use service_radius_miles for search visibility; fall back to notification_radius_miles for backwards compat
  const radius = pi.service_radius_miles || pi.notification_radius_miles || 100
