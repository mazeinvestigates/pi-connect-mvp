...
function generateContractHTML({ piName, clientName, jobTitle, jobLocation, rate, today }) {
  return `
    <div style="font-family: Georgia, serif; max-width: 700px; margin: 0 auto; padding: 40px; color: #1a1a1a; line-height: 1.7;">
      ...
      <p>Client agrees to compensate PI at the rate of ${rate ? `$${rate}/hour` : 'the agreed amount as specified in the job application'}, plus documented expenses. All payments are processed through the PI Connect platform. A 10% platform fee applies to labor charges.</p>
          ...
          {!mode && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              >
                ...
                <p style={{ fontSize: '13px', color: '#6b7280' }}>Use PI Connect's standard engagement agreement, pre-filled with job details. Includes a liability disclaimer absolving PI Connect of responsibility.</p>
              </button>
            </div>
          )}
            ...
            <div>
              ...
              <div className="info-box" style={{ marginBottom: '16px' }}>
                ...
                <p style={{ fontSize: '13px', color: '#374151' }}>
                  ...
                  • Liability disclaimer absolving PI Connect
                </p>
              </div>
