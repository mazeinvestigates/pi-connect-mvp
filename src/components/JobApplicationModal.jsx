                ...
                <div className="form-group">
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginBottom: '8px' }}>
                    <button type="button"
                      ...
                      style={{ padding: '5px 12px', borderRadius: '6px', border: '1px solid #e5e7eb', cursor: 'pointer', fontSize: '12px', background: formData.rateType !== 'flat' ? '#667eea' : 'white', color: formData.rateType !== 'flat' ? 'white' : '#374151' }}>
                      Hourly
                    </button>
                    <button type="button"
