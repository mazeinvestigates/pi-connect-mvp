              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <p style={{ fontSize: '13px', color: '#6b7280', marginBottom: '8px' }}>
                    How far are you willing to travel for a job? Controls which client searches you appear in.
                  </p>
                ...
                <div className="form-group">
                  ...
                  <p style={{ fontSize: '13px', color: '#374151', marginTop: '6px' }}>
                    {formData.notificationRadius === -1
                      ? 'You will receive job match emails for all jobs nationwide'
                      : `You will receive job match emails for jobs within ${formData.notificationRadius} miles of your location`}
                  </p>
                </div>
              </div>
