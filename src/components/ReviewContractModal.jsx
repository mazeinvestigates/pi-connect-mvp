          ...
          {app.contract_type === 'platform' && (
            <div style={{ marginBottom: '20px' }}>
              <p style={{ fontSize: '13px', color: '#374151', marginBottom: '12px' }}>
                This is a standard PI Connect engagement agreement covering scope of work, confidentiality, legal compliance, compensation, and liability terms.
              </p>
              <p style={{ fontSize: '12px', color: '#6b7280' }}>
                Key terms: All work performed legally and confidentially. PI Connect is not liable for investigative outcomes. Either party may cancel before work commences.
              </p>
            </div>
          )}
