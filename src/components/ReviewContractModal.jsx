...
export default function ReviewContractModal({ app, job, user, onClose, onSuccess, onDecline }) {
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      const signerName = job?.profiles?.full_name || user?.email || 'Client'
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          contract_signed_by_name: signerName,
          contract_signed_by_email: signerEmail
        })
        .eq('id', app.id)
            ...
            <div style={{ marginBottom: '20px' }}>
              <div style={{
                ...
                dangerouslySetInnerHTML={{ __html: generateContractHTML({
                  ...
                  escrowAmount: app?.retainer_amount_display_cents ? (app.retainer_amount_display_cents / 100).toFixed(2) : null,
