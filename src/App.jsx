        ...
        <nav className="header-nav desktop-nav">
          {user ? (
            <>
              ...
              {profile?.type === 'pi' && <button className="nav-link" onClick={() => setCurrentPage('subscription')}>⭐ Membership</button>}
              {profile?.type === 'pi' && (
    ...
    <div className="app">
      ...
      <main className="app-main">
        ...
        {currentPage === 'subscription' && (
          <SubscriptionPage user={user} profile={profile} onNavigate={navigateTo} isBeta={true} />
        )}
