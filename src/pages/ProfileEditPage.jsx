  ...
  return (
    <div style={{ background: '#f0fdf4', border: '1px solid #86efac', borderRadius: '8px', padding: '14px 16px' }}>
      ...
      <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap' }}>
        ...
        <button type="button" onClick={copyCode} style={{ fontSize: '12px', padding: '4px 10px', background: 'white', border: '1px solid #86efac', borderRadius: '4px', cursor: 'pointer', color: '#166634' }}>
          {copied ? '✓ Copied' : 'Copy Code'}
        </button>
      </div>
      <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
        <span style={{ fontSize: '12px', color: '#6b7280', wordBreak: 'break-all' }}>{link}</span>
        <button type="button" onClick={copyLink} style={{ fontSize: '12px', padding: '4px 10px', background: '#667eea', border: 'none', borderRadius: '4px', cursor: 'pointer', color: 'white', flexShrink: 0 }}>
