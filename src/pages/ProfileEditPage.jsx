          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <p style={{ fontSize: '13px', color: '#6b7280', marginBottom: '8px' }}>
                How far are you willing to travel to take a job? This determines which jobs you appear in when clients search by location.
              </p>
              ...
              <p style={{ fontSize: '13px', color: '#374151', marginTop: '6px' }}>
                {formData.serviceRadius === -1
                  ...
                  : `${formData.serviceRadius} miles — you will appear in searches within ${formData.serviceRadius} miles of your location`}
              </p>
