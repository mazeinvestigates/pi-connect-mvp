          ...
          <div className="visibility-options">
            <label className="visibility-option">
              ...
              <div>
                ...
                <p>Not visible in the public marketplace. Only you and whoever you subcontract or refer this to can see it. You can convert it to public later if needed.</p>
              </div>
            </label>
