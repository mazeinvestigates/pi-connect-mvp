    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <section>
          ...
          <p><strong>Expense Integrity.</strong> The expense pass-through exemption applies strictly to legitimate, documented out-of-pocket costs incurred in the performance of investigation services (e.g., mileage, filing fees, travel, equipment). Misrepresenting labor as expenses, inflating expense amounts, or otherwise manipulating the expense field to reduce platform fees is strictly prohibited. PI Connect reserves the right to conduct random audits of transaction records. Accounts found to be circumventing platform fees through expense manipulation may be subject to retroactive fee collection and account termination.</p>
        </section>

        <section>
          <h2>6. Payments and Refunds</h2>
          <p>All payments are processed through Stripe. By using the payment features, you agree to Stripe's Terms of Service. PI Connect does not store credit card information.</p>

          <p><strong>Retainer Payments.</strong> When a client pays a retainer, those funds are transferred directly to the PI's connected Stripe account upon payment, minus the 10% platform fee. The PI holds the retainer in their own account and is responsible for any refund arrangements with the client.</p>

          <p><strong>Cancellation Before Work Starts.</strong> If a job is cancelled before the PI has clicked Start Work, PI Connect will automatically reverse the transfer from the PI's Stripe account and issue a full refund to the client's payment method. The platform absorbs the Stripe processing fee in this scenario. The PI is responsible for maintaining sufficient balance in their connected Stripe account to cover any such reversals. If a PI's Stripe Connect account cannot cover a reversal due to funds already having been paid out to their bank account, the PI is personally responsible for the outstanding amount and Stripe may collect it from future deposits or directly from the PI's linked bank account.</p>

          <p><strong>Cancellation After Work Starts.</strong> Once a PI has clicked Start Work, no automatic refund is issued. Any refund of unused retainer funds is handled directly between the PI and client. The PI may issue a full or partial refund from their Stripe Express dashboard at their discretion. PI Connect is not responsible for mediating post-work-start refund disputes, though it may do so at its discretion.</p>

          <p><strong>Invoice Payments.</strong> For jobs using the invoice payment mode, payment is collected after the PI sends an invoice upon completion of work. These payments are generally non-refundable as the work has already been performed.</p>
        ...
        <section>
          <h2>7. Stripe Connect and PI Payouts</h2>
          <p>To receive payments through the Platform, PIs must connect a bank account via Stripe Express. By doing so, you agree to Stripe's Connected Account Agreement. PI Connect is not responsible for delays, failures, or errors in Stripe's payout processing.</p>
          <p>Payouts to connected bank accounts are governed by Stripe's standard payout schedule, typically within two business days of funds becoming available. Once funds have been paid out to a PI's bank account, reversals may result in a negative balance on the PI's Stripe Connect account, which Stripe will collect from future deposits or directly from the PI's linked bank account in accordance with Stripe's Connected Account Agreement.</p>
          <p>PIs are responsible for any taxes arising from payments received through the Platform. PI Connect will issue 1099-K forms where required by law through Stripe.</p>
        </section>
        ...
        <section>
          <h2>9. Confidentiality of Subcontract Arrangements</h2>
        ...
        <section>
          ...
          <p>These Terms are governed by the laws of the State of Florida, without regard to its conflict of law provisions. Any disputes between users and PI Connect arising from these Terms or your use of the Platform shall be resolved in the state or federal courts located in Florida. Note that disputes between clients and private investigators arising from individual engagement agreements are governed by the terms of those agreements, which reference the law of the state in which the investigator is licensed.</p>
        </section>
