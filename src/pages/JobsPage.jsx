    ...
    <div>
      ...
      {jobs.length === 0 ? (
        <div className="empty-state">
          ...
          const activeJobs = jobs.filter(a => !['completed','cancelled'].includes(a.status))
          const archivedJobs = jobs.filter(a => ['completed','cancelled'].includes(a.status))
          return (
            <div className="jobs-list">
              {activeJobs.map(app => renderApp(app))}
                ...
                <div style={{ marginTop: '24px' }}>
                  ...
                  {showArchive && (
                    <div style={{ marginTop: '12px' }}>
                      {archivedJobs.map(app => renderApp(app))}
                    </div>
                  )}
                </div>
              )}
