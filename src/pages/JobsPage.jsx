...
function MyJobsTab({ user, profile, onNavigate }) {
  ...
  const handleSetPaymentMode = async (appId, mode, escrowAmountCents = null) => {
    ...
    try {
      ...
      if (escrowAmountCents) updates.escrow_amount_cents_cents = escrowAmountCents
                      ...
                      <div style={{ marginTop: '10px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                          <input
                            ...
                            defaultValue={app.escrow_amount_cents_cents ? (app.escrow_amount_cents_cents / 100).toFixed(2) : ''}
                        ...
                        {app.escrow_amount_cents_cents && (
                          <p style={{ fontSize: '12px', color: '#059669', marginTop: '4px' }}>
                            ✓ Retainer amount set: ${(app.escrow_amount_cents_cents / 100).toFixed(2)} — client will be prompted to pay this amount before work begins.
                          </p>
                        )}
                        {!app.escrow_amount_cents_cents && (
