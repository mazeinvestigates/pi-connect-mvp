            ...
            return (
              <div key={app.id} className="job-management-card">
                ...
                <div className="job-card-actions">
                  ...
                  {/* Mark work started */}
                  {app.status === 'accepted' && !app.work_started_at && (app.payment_mode === 'invoice' || !app.payment_mode) && (
                  ...
                  {/* Send invoice */}
                  {app.work_started_at && !app.invoice_sent_at && (app.payment_mode === 'invoice' || !app.payment_mode) && (
                    <button className="btn-primary"
                      disabled={updating === app.id}
                  ...
                  {app.payment_mode === 'escrow' && app.work_started_at && !app.additional_escrow_status && (
