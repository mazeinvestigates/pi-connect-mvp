...
export default function EmailPreferencesPage({ user, onNavigate }) {
  ...
  const preferenceOptions = [
    ...
    },
    {
      ...
      description: 'Get emailed when a new job matching your specialties is posted (PIs only)'
    },
    {
    ...
    },
    {
      ...
      description: 'Get notified when your PI sends you an invoice ready for payment (Clients only)'
    },
    {
      key: 'reviews',
      title: 'New Reviews',
