...
import { UnverifiedBanner } from '../components/VerificationGate'

export default function MessagingPage({ user, profile, onNavigate }) {
  ...
  return (
    <div className="messaging-page">
      <div className="messaging-container">
        ...
        {profile?.type === 'pi' && !profile?.is_verified ? (
          <div className="empty-state">
            <div style={{ fontSize: '40px', marginBottom: '16px' }}>🔒</div>
            <h3>Messaging requires verification</h3>
            <p>Once your credentials are reviewed and approved, you'll be able to message clients directly. Our team typically verifies within 24–48 hours.</p>
            <button className="btn-primary" onClick={() => onNavigate('profile-edit')}>
              Complete My Profile
            </button>
          </div>
